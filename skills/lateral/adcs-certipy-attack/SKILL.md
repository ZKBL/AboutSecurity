...
- ⛔**必读** ESC1-ESC11 各漏洞详细利用命令和条件 → `read_skill(id="adcs-certipy-attack", path="references/esc-techniques.md")`
...
详细命令 → `read_skill(id="adcs-certipy-attack", path="references/esc-techniques.md")`
```
